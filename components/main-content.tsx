...
export function MainContent() {
  ...
  const handleViber = () => {
    ...
    window.location.href = `tel:+95${phoneNumber.substring(1)}`
  }
              ...
              >
                ...
                <div className="space-y-2 mt-4">
                  <button
                    ...
                    className="flex items-center space-x-2 bg-green-600/80 hover:bg-green-600 px-4 py-2 rounded-full transition-all duration-300 transform hover:scale-105 w-full"
                  >
                    <Phone className="w-4 h-4 text-white" />
                    <span className="text-white font-semibold">09779986788</span>
                  </button>
                  <button
                  ...
                  >
                    <Phone className="w-4 h-4 text-white" />
                    <span className="text-white font-semibold">09254425040</span>
                  </button>
                  <button
